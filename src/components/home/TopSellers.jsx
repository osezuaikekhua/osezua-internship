            ...
            {responseList.length
                ? responseList.map((item, index) => (
                    <li key={index}>
                      ...
                      <div className="author_list_info" data-aos="fade-zoom-in" data-aos-easing="ease" data-aos-delay="100" data-aos-offset="0" data-aos-duration="2000">
                        <Link to={`/author/${item.authorId}`}>
                          {item.authorName}
                        </Link>
                        <span data-aos="fade-zoom-in" >{item.price} ETH</span>
                      </div>
                    </li>
                  ))
                : Array(12)
